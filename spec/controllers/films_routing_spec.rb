...
describe FilmsController do
  describe "route generation" do
    ...
    it "should map { :festival_id => '1', :controller => 'films', :action => 'update', :id => '1'} to /festivals/1/films/1" do
      route_for(:festival_id => '1', :controller => "films", :action => "update", :id => '1').should == {:path => "/festivals/1/films/1", :method => :put}
    end
  
    it "should map { :festival_id => '1', :controller => 'films', :action => 'destroy', :id => '1'} to /festivals/1/films/1" do
      route_for(:festival_id => "1", :controller => "films", :action => "destroy", :id => "1").should == {:path => "/festivals/1/films/1", :method => :delete}
    end
  end
